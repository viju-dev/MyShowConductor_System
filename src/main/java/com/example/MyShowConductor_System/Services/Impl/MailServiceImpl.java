...
import com.example.MyShowConductor_System.Services.MailService;
...
public class MailServiceImpl implements MailService {
    ...
    public void sendBookingMail(Ticket ticket, Show show)  throws MessagingException{//throws MessagingException
        String text = "<table  style='width:60%;height:auto;border:1px solid #e5e5e5;border-radius: 1px;background-color:Grey#fff;margin: 0 auto'>" +
                ...
                "    <tbody>" +
                "        <tr>" +
                "        <td><h2>Movie : <b style='color:black;'>"+ticket.getShow().getMovie().getTitle()+"</b></h2></td>" +
                "      </tr>  " +
                "      <tr>" +
...
//        ticketRepository.deleteById(ticket.getId());
    ...
    public void sendMail(String email,String text,String subject) throws MessagingException {//throws MessagingException
